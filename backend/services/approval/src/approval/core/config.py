"""Definições do serviço approval (pydantic-settings, tudo por env var)."""
...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+psycopg://approval_svc:approval_dev_pw@localhost:5432/ops"
    db_schema: str = "approval"
