"""Approval Service — app factory e lifespan.

Perfil: HTTP + publisher.
...
from approval.api import health
from approval.api.error_handler import registar_error_handlers
from approval.api.v1.router import router as router_v1
