"""Reporting Service — app factory e lifespan.
...
from reporting.api import health
from reporting.api.error_handler import registar_error_handlers
from reporting.api.v1.router import router as router_v1
