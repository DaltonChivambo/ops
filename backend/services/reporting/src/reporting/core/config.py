"""Definições do serviço reporting (pydantic-settings, tudo por env var)."""
...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+psycopg://reporting_svc:reporting_dev_pw@localhost:5432/ops"
    ...
    rabbitmq_queue: str | None = "reporting.events"
