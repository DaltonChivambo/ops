...
from ticketing.infrastructure.persistence.models.base import Base, Timestamps

# TODO: from ticketing.infrastructure.persistence.models.<agregado> import <Model>
