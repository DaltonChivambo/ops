"""Definições do serviço ticketing (pydantic-settings, tudo por env var)."""
...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+psycopg://ticketing_svc:ticketing_dev_pw@localhost:5432/ops"
    db_schema: str = "ticketing"
    ...
    rabbitmq_queue: str | None = "ticketing.events"
