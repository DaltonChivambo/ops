"""Asset Service — app factory e lifespan.

Perfil: HTTP + publisher + scheduler.
...
from asset.api import health
from asset.api.error_handler import registar_error_handlers
from asset.api.v1.router import router as router_v1
