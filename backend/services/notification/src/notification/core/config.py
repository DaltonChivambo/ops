"""Definições do serviço notification (pydantic-settings, tudo por env var)."""
...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+psycopg://notification_svc:notification_dev_pw@localhost:5432/ops"
    ...
    rabbitmq_queue: str | None = "notification.events"
