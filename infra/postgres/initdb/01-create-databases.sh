...
create_database "mozaops_pos_closing_credit_validation" "$DB_RECONCILIATION_USER" "$DB_RECONCILIATION_PASSWORD"
...
create_test_database "mozaops_pos_closing_credit_validation_test" "$DB_RECONCILIATION_USER"
